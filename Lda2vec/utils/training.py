...
def train(data, unigram_distribution, word_vectors,
    ...
    unigram_distribution = unigram_distribution.cpu()
    ...
    if doc_weights_init is not None:
        ...
        model.doc_weights.weight.data = torch.FloatTensor(doc_weights_init).cpu()
    params = [
    ...
    try:
        for epoch in range(1, n_epochs + 1):
            ...
            for batch in tqdm(iterator):
                ...
                noise = sigma*Variable(torch.randn(doc_weights_shape).cpu())
